...
export class WemaParser implements IEmailParser {
  public readonly parserId = '6ba7b810-9dad-11d1-80b4-00c04fd430c9'
  ...
  public async parse(subject: string, bodyHtml: string, bodyText: string): Promise<ParsedTransaction | null> {
    ...
    const merchantName = descMatch && descMatch[1] ? descMatch[1].trim() : 'Wema Bank Transaction'
